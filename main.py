...
food = "wings"
number = int(24)
print(f"Once upon a time, there was a {age_} old coder named {name_}. {name_} liked to hum the song {song} while coding. It was so annoying that their teammates would throw {food} until {name_} would stop singing. Still, {name_} was the best coder on the team and could write {number} lines of code every day. Maybe {song} was {name_}’s secret power?")
...
# The percentage of marks obtained by a student percent_marks
...
# age_of_hancockHighSchool = input("what is your age at hancock highschool? ")
...
# Print the data type of that value
